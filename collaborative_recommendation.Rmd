...
eval_sets <- evaluationScheme(ratingmat, method="split", train=percent_train, given=items_to_keep, goodRating=0)
eval_sets
```

- **Build Recommender Model**

Build Recommender Model using User-Based Collaborative Filtering using `recommenderlab` library. Set method equals to "UBCF", use Cosine Similarity and 30 Nearest Neighbors as parameters.
```{r}
...
eval_prediction = predict(object = UBCF_model,
